      ...
      <section className="py-16 bg-white relative overflow-hidden border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="inline-flex items-center justify-center p-4 bg-brand-green/10 rounded-full mb-4 group-hover:scale-110 transition-transform">
                <HomeIcon className="h-8 w-8 text-brand-green" />
              </div>
              <h3 className="text-4xl sm:text-5xl font-black text-gray-900 mb-2">+300</h3>
              <p className="text-lg font-bold text-gray-500 uppercase tracking-widest">Imóveis</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="text-center"
            >
              <div className="inline-flex items-center justify-center p-4 bg-brand-purple/10 rounded-full mb-4 group-hover:scale-110 transition-transform">
                <Building2 className="h-8 w-8 text-brand-purple" />
              </div>
              <h3 className="text-4xl sm:text-5xl font-black text-gray-900 mb-2">+10</h3>
              <p className="text-lg font-bold text-gray-500 uppercase tracking-widest">Imobiliárias</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="text-center"
            >
              <div className="inline-flex items-center justify-center p-4 bg-amber-100 rounded-full mb-4 group-hover:scale-110 transition-transform">
                <Users className="h-8 w-8 text-amber-600" />
              </div>
              <h3 className="text-4xl sm:text-5xl font-black text-gray-900 mb-2">+100</h3>
              <p className="text-lg font-bold text-gray-500 uppercase tracking-widest">Utilizadores</p>
            </motion.div>
          </div>
        </div>
      </section>
